...
public class ReportFragment01 extends Fragment implements OnChartValueSelectedListener{
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view == null){
            view = inflater.inflate(R.layout.fragment_report01,container,false);
        }
        //设置饼状图
        pieChart = view.findViewById(R.id.report_pieChar01);
        ...
        Map<String,Double> hs = DbManager.getInstance(getContext()).getCountForCate("1");
        if (!hs.isEmpty()){
...
//                L.e(key+"-----"+val);
    ...
    private CharSequence generateCenterSpannableText() {
        String str = "总支出\n"+DbManager.getInstance(getContext()).ExCountForAll(1);
    ...
    private void setData(ArrayList<PieEntry> entries) {
        PieDataSet dataSet = new PieDataSet(entries, "所有月份的总支出");
